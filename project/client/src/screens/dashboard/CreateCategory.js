...
const CreateCategory = () => {
  ...
  return (
    <Wrapper>
      <ScreenHeader>
        <Link to="/dashboard/categories" className="btn btn-warning">
          Danh sách sản phẩm <i className="bi bi-arrow-left-short"></i>
        </Link>
      </ScreenHeader>
      <form className="w-full md:w-8/12" onSubmit={submitCategory}>
        <h3 className="text-lg capitalize mb-3">Tạo sản phẩm</h3>
        {errors.length > 0 &&
